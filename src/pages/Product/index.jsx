                        ...
                        <div className="col-12">
                            <div className="row">
                                <div className="col-12 col-md-6">
                                    ...
                                    <div className="card">
                                        {/* Badge */}
                                        <div className="badge badge-primary card-badge text-uppercase" style={{ zIndex: 10 }}>
                                            Sale
                                        </div>
                                        {/* Slider */}
                                        <Swiper
                                            className="flickity-page-dots-inner mb-5"
                                            style={{ width: "100%" }}
                                            modules={[Thumbs]}
                                            thumbs={{ swiper: thumbSwiper }}>
                                            {/* Item */}
                                            <SwiperSlide>
                                                <a href="/img/products/product-7.jpg">
                                                    <img src="/img/products/product-7.jpg" alt="..." className="card-img-top" />
                                                </a>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <a href="/img/products/product-122.jpg">
                                                    <img src="/img/products/product-122.jpg" alt="..." className="card-img-top" />
                                                </a>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <a href="/img/products/product-146.jpg">
                                    ...
                                    {/* Slider */}
                                    <Swiper modules={[Thumbs]} watchSlidesProgress onSwiper={setThumbSwiper} className="flickity-nav mx-n2 mb-10 mb-md-0">
                                        <SwiperSlide className="mr-5" style={{ maxWidth: "90px" }}>
                                            {/* Image */}
                                            <div
