                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="text-center text-white">
                                <span className="heading-xxs letter-spacing-xl">⚡️ Happy Holiday Deals on Everything ⚡️</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-12 col-md-10 col-lg-8 col-xl-6">
                                ...
                                <div className="nav justify-content-center mb-10">
                                    <Tab.Title id="woman">Women</Tab.Title>
                                    <Tab.Title id="man">Man</Tab.Title>
                                    <Tab.Title id="kids">Kids</Tab.Title>
                                </div>
                            </div>
                        </div>
                        <div className="tab-content">
                            <Tab.Content id="woman">
                                <div className="row">
                            ...
                            <Tab.Content id="man">Man</Tab.Content>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <blockquote className="mb-0">
                                                <p className="text-muted">
                                                    From creepeth said moved given divide make multiply of him shall itself also above second doesn't unto
                                ...
                                <div className="col-12 col-sm-8 col-md-6 col-lg-4">
                                    ...
                                    <div className="card-lg card border">
                                        <div className="card-body">
                                            ...
                                            <blockquote className="mb-0">
                                                <p className="text-muted">
                                                    God every fill great replenish darkness unto. Very open. Likeness their that light. Given under image to.
                                                    Subdue of shall cattle day fish form saw spirit and given stars, us you whales may, land, saw fill unto.
                                                </p>
                                                <footer className="font-size-xs text-muted">
                                ...
                                <div className="col-12 col-sm-8 col-md-6 col-lg-4">
                                    ...
                                    <div className="card-lg card border">
                                        <div className="card-body">
                                            ...
                                            <blockquote className="mb-0">
                                                <p className="text-muted">
                                                    Fill his waters wherein signs likeness waters. Second light gathered appear sixth fourth, seasons behold
                                                    creeping female.
                                                </p>
                                                <footer className="font-size-xs text-muted">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 text-center">
                            ...
                            {/* Subheading */}
                            <p className="mb-10 font-size-lg text-gray-500">Appear, dry there darkness they're seas, dry waters.</p>
                        </div>
                    </div>
